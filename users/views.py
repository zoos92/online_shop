...
class UserRegistrationView(CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, f"{user.username}, Вы успешно зареганы вошли в аккаунт")
...
class UserProfileView(LoginRequiredMixin, CacheMixin, UpdateView):
    ...
    def form_valid(self, form):
        messages.success(self.request, f"{self.request.user.username}, успешно обновлён аккаунт")
...
#         if form.is_valid():
#                 form.save()
#                 messages.success(request, f"{request.user.username}, успешно обновлён аккаунт")
...
#                 if session_key:
#                      Cart.objects.filter(session_key=session_key).update(user=user)
#                 messages.success(request, f"{user.username}, Вы успешно зареганы вошли в аккаунт")
#                 return HttpResponseRedirect(reverse('main:index'))
#     else:
